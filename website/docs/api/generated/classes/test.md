...
* [context](test.md#context)
* [props](test.md#props)
* [refs](test.md#refs)
* [state](test.md#state)
* [contextType](test.md#static-optional-contexttype)

### Methods

* [UNSAFE_componentWillMount](test.md#optional-unsafe_componentwillmount)
* [UNSAFE_componentWillReceiveProps](test.md#optional-unsafe_componentwillreceiveprops)
* [UNSAFE_componentWillUpdate](test.md#optional-unsafe_componentwillupdate)
* [componentDidCatch](test.md#optional-componentdidcatch)
* [componentDidMount](test.md#optional-componentdidmount)
* [componentDidUpdate](test.md#optional-componentdidupdate)
* [componentWillMount](test.md#optional-componentwillmount)
* [componentWillReceiveProps](test.md#optional-componentwillreceiveprops)
* [componentWillUnmount](test.md#componentwillunmount)
* [componentWillUpdate](test.md#optional-componentwillupdate)
* [forceUpdate](test.md#forceupdate)
* [getSnapshotBeforeUpdate](test.md#optional-getsnapshotbeforeupdate)
* [render](test.md#render)
* [setState](test.md#setstate)
* [shouldComponentUpdate](test.md#optional-shouldcomponentupdate)

## Constructors

###  constructor

\+ **new Test**(`props`: Readonly‹any›): *[Test](test.md)*
...
**Returns:** *[Test](test.md)*

\+ **new Test**(`props`: any, `context?`: any): *[Test](test.md)*
...
*Inherited from [Test](test.md).[state](test.md#state)*
